...
<div class="glass-inner border-t border-white/10 px-4 py-4 mx-4 mb-4 rounded-2xl backdrop-blur-md">
    ...
    <form @submit.prevent="sendMessage()" class="flex items-end gap-3">
        ...
        <textarea
            ...
            rows="1"
            :disabled="loading"
            class="flex-1 resize-none bg-transparent border border-white/20
                   focus:border-[#1a6fa8]/50 focus:ring-0 focus:outline-none
                   text-[#1a3a52] placeholder-[#1a3a52]/40 text-sm
        ...
        <button
            ...
            class="glass-inner w-10 h-10 rounded-xl
